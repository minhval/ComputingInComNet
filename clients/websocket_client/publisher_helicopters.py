...
DEVICE_TYPE = "HELICOPTER"
DEVICE_NAME = "HelicopterNo"
...
while True:
    ...
    for i in range(0, NUM_OF_DRONES):        
        ...
        randLat = uniform(-0.01, 0.01)
        randLon = uniform(-0.01, 0.01)

        device_id = DEVICE_IDs[i]
        
        current_x = DEVICES_LIST[device_id]["gps_latitude"] + randLat
        current_y = DEVICES_LIST[device_id]["gps_longitude"] + randLon
